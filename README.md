...
**Version 1.4.0:** Independent **Υπηρεσίες** overview template with four alternating image/text rows and 25 ACF Free fields. Includes automatic links to published overview and individual-session templates. See [overview setup](docs/services-overview.md). New rules are in style.css and the existing responsive blocks.
